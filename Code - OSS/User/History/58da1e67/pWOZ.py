#gcloud run deploy multi-tenant-app   --source .   --region asia-south1   --allow-unauthenticated   --set-env-vars llm_api="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
...
client = OpenAI(
  ...
  api_key = "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"
)
